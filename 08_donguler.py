...
# Liste elemanları içerisinde filtreleme yapalım
...
print(f"{baslangic} sayısının faktöryeli {faktoriyel} sayısıdır.")
...
# Liste elemanlarının değerlerini değiştirelim kısaca yapalım
